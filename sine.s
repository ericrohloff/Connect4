...
;**********************************************************************************
;   uint16_t sine(uint16 angle_in_degrees);
;**********************************************************************************
; Register used:
; Input Arguments
;	r0 = sin argument (in degrees)
;
; Return:
...
;**********************************************************************************
	...
	AREA    mySINE, CODE, READONLY

sine	PROC  
	EXPORT sine
	PUSH  {r4, r5, r6, lr}  ; stack used registers
	MOV   r1, r0            ; make a copy of the input argument
